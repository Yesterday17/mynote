...
function mynote_default_nav() {
    ...
    <div id="mynote-nav-bar" class="collapse navbar-collapse">
        <ul id="menu-primary-menu" class="navbar-nav mr-auto">
            <li class="nav-item"><a href="<?php echo esc_url(home_url()); ?>"
                                    class="nav-link"><?php esc_html_e('Home', 'mynote'); ?></a></li>
        </ul>
    </div>
    <?php
}
        ...
        <nav aria-label="Page navigation" role="navigation">
            ...
            <ul class="pagination justify-content-center ft-wpbs">
                ...
                <?php if ($current > 2 && $current > $range + 1 && $pagi_items < $pages) : ?>
                    ...
                    <li class="page-item">
                        <a class="page-link" href="<?php echo esc_url(get_pagenum_link(1)); ?>"
                           aria-label="<?php esc_attr_e('First Page', 'mynote'); ?>">
                            &laquo;<span
                                    class="hidden-sm-down d-none d-md-inline-block">&nbsp;<?php esc_html_e('First', 'mynote'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if ($current > 1 && $pagi_items < $pages) : ?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo esc_url(get_pagenum_link($current - 1)); ?>"
                           aria-label="<?php esc_attr_e('Previous Page', 'mynote'); ?>">
                            &lsaquo;<span
                                    class="hidden-sm-down d-none d-md-inline-block">&nbsp;<?php esc_html_e('Previous', 'mynote'); ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <?php if ($current < $pages && $pagi_items < $pages) : ?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo esc_url(get_pagenum_link($current + 1)); ?>"
                           aria-label="<?php esc_attr_e('Next Page', 'mynote'); ?>">
                ...
                <?php if ($current < $pages - 1 && $current + $range - 1 < $pages && $pagi_items < $pages) : ?>
                    <li class="page-item">
                        <a class="page-link" href="<?php echo esc_url(get_pagenum_link($pages)); ?>"
                           aria-label="<?php esc_attr_e('Last Page', 'mynote'); ?>">
    ...
    function mynote_author_card($avatar_size = 96, $icon_size = 'sm') {
        ...
        <aside class="author-card" itemscope itemprop="author" itemtype="http://schema.org/Person">
            <div class="author-avatar">
                <img src="<?php echo esc_url(get_avatar_url(get_the_author_meta('ID'), array('size' => $avatar_size))); ?>"
                ...
                <ul class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                    <li class="breadcrumb-item" itemprop="itemListElement" itemscope
                        ...
                        <a href="<?php echo esc_url(get_home_url()); ?>" itemprop="item">
                            <span itemprop="name"><i class="fas fa-globe"></i><span
                                        class="sr-only"><?php esc_html_e('Home', 'mynote'); ?></span></span>
                        </a>
                    ...
                    <?php if (!empty($first_cat)) : ?>
                        <li class="breadcrumb-item" itemprop="itemListElement" itemscope
                            itemtype="http://schema.org/ListItem">
                            <a href="<?php echo esc_url(get_term_link($first_cat->slug, 'category')); ?>"
                               itemprop="item">
                    ...
                    <?php if (!empty($child_cat)) : ?>
                        <li class="breadcrumb-item" itemprop="itemListElement" itemscope
                            ...
                            <a class="breadcrumb-item"
                               href="<?php echo esc_url(get_term_link($child_cat->slug, 'category')); ?>"
                               itemprop="item">
